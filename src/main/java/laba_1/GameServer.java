...
public class GameServer {
    ...
    private void loadConfig() throws IOException{
        ...
        if (this.gameConfig==null){
            ...
            FileUtils.saveConfig(new File("gconfig.json"), this.gameConfig);
        }
    }
    private void loadWorld() throws IOException{
        this.serverWorld = FileUtils.loadWorld(new File("world.txt"));
        if(this.serverWorld == null){
            ...
            FileUtils.saveWorld(new File("world.txt"), this.serverWorld);}
    }
    @Override
