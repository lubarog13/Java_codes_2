...
public class DialogTrainUtil {

    public static void showError(Component parentComponent, String text) {
        JOptionPane.showInputDialog(parentComponent, text, "Ошибка", JOptionPane.ERROR_MESSAGE);
    }
    ...
    public static void showWarn(Component parentComponent, String text) {
        JOptionPane.showInputDialog(parentComponent, text, "Предупреждение", JOptionPane.WARNING_MESSAGE);
    }
